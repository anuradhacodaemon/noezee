                ...
                <table class="table table-striped responsive-utilities jambo_table bulk_action">
                    <thead>
                        <tr class="headings">
                            ...
                            <th class="column-title table-font">Child Device</th>


                            <th class="column-title no-link last"><span class="nobr">Created At</span>
                            </th>
                        ...
                        if (count($joblisting) > 0) {
                            ...
                            foreach ($joblisting as $k => $v) {
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td class=" ">                                        <a href="<?php echo BASE_URL . 'admin/media/details/' . $v['media_id'] ?>" class="dark_grey " >
<?php
