...
class Device extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('admin/device_model');
    }
    ...
    public function index() {
        ...
        if (!isset($this->session->userdata['userdata']['ud'])) {
            ...
            $config['base_url'] = base_url() . MASTERADMIN . '/device';
       ...
       public function details($userId = 0, $page = 0) {
        ...
        if (!isset($this->session->userdata['userdata']['ud'])) {
            ...
            $this->load->view('admin', $data);
                ...
                $config['base_url'] = base_url()  . 'admin/device/details/' . $userId;
                ...
                $data['joblisting'] = $this->device_model->get_mediadetails($page, $config['per_page'],$userId);
