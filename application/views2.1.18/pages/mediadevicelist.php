<?php $device_name=$this->media_model->get_device_name($device_id);?>
                ...
                if (count($joblisting) > 0) {
                    ...
                    <div class="inner-cont clearfix">
                        <div class="cont-heading clearfix">
                            <h2><b></b> <a href="<?php echo BASE_URL ?>parent/media/device/<?php echo $device_id . '/' . $date ?>"><?php echo  $device_name[0]['device_name'] ?></a></h2>
                    ...
                    <div class="col-md-12" id="shareDiv" style="display:none;">
                        <div class="share-icon">
                           ...
                           <!-- <a href="#"><img src="<?php echo BASE_URL; ?>public/web/img/googleplus.png" class="img-responsive"></a>-->
                            ...
                            <a href="#" id="emailDiv"><img src="<?php echo BASE_URL; ?>public/web/img/email.png" width="35" height="35" class="img-responsive"></a>
                        </div>
                    </div>
                </div>
            </div>
