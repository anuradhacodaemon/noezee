                       ...
                       if( count($media)>0) {
                        ...
                        <div class="inner-cont clearfix">
                            <div class="cont-heading clearfix">
                                <h2><b></b> <a href="<?php echo BASE_URL ?>parent/media/device/<?php echo $v['device_id'] . '/' . date("d-m-Y", strtotime($v['date'])) ?>"><?php echo $v['device_name'] ?></a></h2>
        ...
        <div class="modal-dialog vertical-align-center">
            <div class="modal-content">
                <div class="modal-header text-right">
                    <a href="#" title="Share" onclick="getShare()"><img src="<?php echo BASE_URL; ?>public/web/img/share-icon.png" alt=""></a>
                ...
                <div class="modal-footer">
                    <div class="col-md-12"  id="shareDiv" style="display:none;">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-4 margin-t-10-mob">
                            <a href="<?php echo BASE_URL . 'parent/media/email/' ?>" id="emailDiv"><img src="<?php echo BASE_URL; ?>public/web/img/email.png" width="30" height="30" class="img-responsive"></a>
                        </div>
                    </div>
                </div>
            </div>
