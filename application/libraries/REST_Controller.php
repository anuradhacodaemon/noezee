...
header('Access-Control-Allow-Headers: Content-Type, x-xsrf-token, neo-x-api-key, neo-X-API-KEY,content-type');
...
abstract class REST_Controller extends CI_Controller {
    ...
    protected function _detect_method()
    {
        ...
        if (empty($method))
        {
            ...
            //suggested by shrikant sir starts
            if($method == "options")
            {
                $method = $this->input->server('Access-Control-Request-Method');
            }
            //suggested by shrikant sir ends
        }
