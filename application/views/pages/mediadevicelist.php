    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="breadcrumb clearfix">
                  ...
                  <li><a href="<?php echo BASE_URL ?>parent/media">Media</a></li>
                  <li class="active">Media Listing</li>
                </ul>
        ...
        <?php } ?>  
                    ...
                    <div id="datatable-fixed-header_paginate" class="dataTables_paginate paging_simple_numbers">
                        ...
                        <?php if ($total_rows > RECORD_LIMIT) { ?>
                            <ul class="pagination">
                            <?php
                            // SHOW PAGE NUMBERS
                            $url = BASE_URL . 'parent/medialist/' . $device_id . '/' . $Date . '/';
    ...
    <div class="vertical-alignment-helper">
        <div class="modal-dialog vertical-align-center">
            <div class="modal-content">
                <div class="modal-header text-right pull-right">
...
<!--<a href="#"><img src="<?php echo BASE_URL; ?>public/web/img/twitter.png" class="img-responsive"></a>-->
   ...
   <!-- <a href="#"><img src="<?php echo BASE_URL; ?>public/web/img/googleplus.png" class="img-responsive"></a>-->
                            <a id="gplus" href="https://plus.google.com/share?url=<?php echo $_SERVER['PHP_SELF'] ?>" onclick="javascript:window.open(this.href,
                                    ...
                                    return false;"><img src="<?php echo BASE_URL; ?>public/web/img/google.png" width="35" height="35" class="img-responsive"></a>

                            <a href="mailto:<?php echo $this->session->userdata['ud']['adminusername'] ?>" id=""><img src="<?php echo BASE_URL; ?>public/web/img/email.png" width="35" height="35" class="img-responsive"></a>
                        </div>
                    </div>
                </div>
