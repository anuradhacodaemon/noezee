                    ...
                    foreach ($joblisting as $k => $v) {
                        ...
                        <div class="inner-cont clearfix">
                            <div class="cont-heading clearfix">
                                <h2><b><a title="click to view image/video" href="<?php echo BASE_URL ?>parent/medialist/<?php echo $v['device_id'] . '/' . date("d-m-Y", strtotime($v['date'])) . '/1' ?>"><?php echo $v['device_name'] ?></a></b><a class="tooltip-main" href="javascript:void(0);" data-toggle="tooltip" title="Please click on parent id to view all images"><i class="fa fa-info-circle"></i></a></h2>
