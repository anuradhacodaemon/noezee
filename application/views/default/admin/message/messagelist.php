    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <li><a href="<?php echo BASE_URL.'admin/welcome'?>" style="color:#000">Home</a></li>
              <li><a href="<?php echo BASE_URL ?>admin/senderlist" style="color:#000">Device Listing</a></li>
              <li><a href="<?php echo BASE_URL.'admin/senders/'.$device_id.'/1'  ?>" style="color:#000">Sender Listing</a></li>
                ...
                <div class="admin-cont clearfix">
                    ...
                    if (count($joblisting) > 0) {
                        ...
                        foreach ($joblisting as $k => $v) {
                            ...
                            $user_data2 = $this->message_model->get_sendermessage( $v['currentdate'],$device_id,$received_user_address);
                            ?><div class="datebox clearfix">
                                <div class="x_content"><?php echo $date; ?></div>
                    ...
                    if ($total_rows > RECORD_LIMIT) { ?><ul class="pagination">
                        <?php
                        // SHOW PAGE NUMBERS
                        $url = BASE_URL . 'admin/messagelist/' . $msg_id . '/' . $device_id . '/';
