                ...
                if (count($joblisting) > 0) {
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                    <div class="img-thumbnail clearfix">
                                        <div class="img-cont clearfix"><?php
                                            if ($v1['type'] == 'jpg' || $v1['type'] == 'jpeg' || $v1['type'] == 'gif' || $v1['type'] == 'png' || $v1['type'] == 'bmp') {
                                                ...
                                                if ($v1['type'] == '.3gp') {
                                                    $type = 'video';
                                                    echo 'Your browser does not support 3gp video';
                                                } else {
                                                    $type = 'video';
                                                    ?>                      
                    ...
                    <div id="datatable-fixed-header_paginate" class="dataTables_paginate paging_simple_numbers">
                        <?php if ($total_rows > RECORD_LIMIT) { ?> <ul class="pagination">
                            <?php
                            // SHOW PAGE NUMBERS
                            $url = BASE_URL . 'parent/gallery/' . $type2 . '/' . $device_id . '/';
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <!--<a href="#"><img src="<?php echo BASE_URL; ?>public/web/img/twitter.png" class="img-responsive"></a>-->
                            <a id="twdiv" class="twitter-share-button"
                               ...
                               data-related="twitterapi,twitter">
                                <img src="<?php echo BASE_URL; ?>public/web/img/tw.png" width="35" height="35" class="img-responsive">
                            </a>
   ...
   <!-- <a href="#"><img src="<?php echo BASE_URL; ?>public/web/img/googleplus.png" class="img-responsive"></a>-->
                            ...
                            <a href="mailto:<?php echo $this->session->userdata['ud']['adminusername'] ?>"><img src="<?php echo BASE_URL; ?>public/web/img/email.png" class="img-responsive" width="35" height="35"></a>
                        </div>
                    </div>
                </div>
